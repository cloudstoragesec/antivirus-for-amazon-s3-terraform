  ...
  container_definitions = jsonencode([
    {
      ...
      "environment" : [
        ...
        { "name" : "QUARANTINE_BUCKET_NAME_PREFIX", "value" : "${var.quarantine_bucket_prefix}-${var.ssm_doc_name_prefix}" },
        ...
        { "name" : "APP_CONFIG_DOCUMENT_NAME", "value" : "${local.ssm_doc_name}" },
        # {"name" : "APP_CONFIG_DOCUMENT_NAME", "value" :"${var.service_name}Config-Doc-${aws_appconfig_application.AppConfigAgentApplication.id}"},
        { "name" : "APP_CONFIG_DOCUMENT_SCHEMA_NAME", "value" : "${local.ssm_schema_doc_name}" },
