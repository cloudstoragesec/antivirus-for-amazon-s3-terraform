resource "aws_ecs_task_definition" "TaskDefinition" {
  ...
  #Currently changing values from here so customers can do it as well, or I can add it as variable, will it work #Pending
  cpu = "512"
  memory = "1024"
  ...
  container_definitions = jsonencode([
    {
      ...
      essential = true
      #What exactly is this in console #Pending
